...
systemDictionary = {
	...
	"FahrplanConfigErrorInstance":{
		"en": "Please activate instance",
		"de": "Bitte Instanz aktivieren",
		"ru": "Пожалуйста, активируйте экземпляр",
		"pt": "Por favor, ative a instância",
		"nl": "Activeer de instantie",
		"fr": "Veuillez activer l'instance",
		"it": "Si prega di attivare l'istanza",
		"es": "Activa la instancia",
		"pl": "Aktywuj instancję",
		"zh-cn": "请激活实例"
	},
	"FahrplanConfigErrorHeader":{
		"en": "<center>Configuration error detected!</center>",
		"de": "<center>Konfigurationsfehler erkannt!</center>",
		"ru": "<center>Обнаружена ошибка конфигурации!</center>",
		"pt": "<center>Erro de configuração detectado!</center>",
		"nl": "<center>Configuratiefout gedetecteerd!</center>",
		"fr": "<center>Erreur de configuration détectée!</center>",
		"it": "<center>Rilevato errore di configurazione!</center>",
		"es": "<center>¡Error de configuración detectado!</center>",
		"pl": "<center>Wykryto błąd konfiguracji!</center>",
		"zh-cn": "<center>检测到配置错误！</center>"
	},
	"FahrplanConfigErrorFooter":{
		"en": "<center>Changes not saved.<br/>Please fix problems and save again.</center>",
		"de": "<center>Änderungen nicht gespeichert.<br/>Bitte Probleme beheben und erneut speichern.</center>",
		"ru": "<center>Изменения не сохраняются.<br/>Пожалуйста, исправьте проблемы и сохраните снова.</center>",
		"pt": "<center>Alterações não salvas.<br/>Corrija os problemas e salve novamente.</center>",
		"nl": "<center>Wijzigingen niet opgeslagen.<br/>Los problemen op en sla opnieuw op.</center>",
		"fr": "<center>Modifications non enregistrées.<br/>Veuillez résoudre les problèmes et enregistrer à nouveau.</center>",
		"it": "<center>Modifiche non salvate.<br/>Risolvi i problemi e salva di nuovo.</center>",
		"es": "<center>Cambios no guardados.<br/>Solucione los problemas y vuelva a guardar.</center>",
	...
	"FahrplanConfigErrorStationFrom":{
		...
		"ru": "<center>Неизвестная начальная станция (От) %s  на маршруте %s</center>",
		"pt": "<center>Estação de partida desconhecida (de) %s  na rota %s</center>",
		"nl": "<center>Onbekend startstation (van) %s  in route %s</center>",
		"fr": "<center>Station de départ inconnue (de) %s  dans l'itinéraire %s</center>",
		"it": "<center>Stazione di partenza sconosciuta (da) %s  nel percorso %s</center>",
		"es": "<center>Estación de inicio desconocida (desde) %s  en la ruta %s</center>",
		"pl": "<center>Nieznana stacja początkowa (z) %s  na trasie %s</center>",
		"zh-cn": "<center>路线％s中的未知起点站（发自）％s</center>"
	},
	"FahrplanConfigErrorStationTo":{
		"en": "<center>Unknown Destination-Station (To) %s in Route %s</center>",
		"de": "<center>Unbekannte Zielstation (Von) %s in Route %s</center>",
		"ru": "<center>Неизвестная конечная станция (к) %s  на маршруте %s</center>",
		"pt": "<center>Destino Desconhecido - Estação (Para) %s  na Rota %s</center>",
		"nl": "<center>Onbekend bestemmingsstation (naar) %s  in route %s</center>",
		"fr": "<center>Destination-Station (À) %s  inconnue dans l'itinéraire %s</center>",
		"it": "<center>Stazione di destinazione sconosciuta (verso) %s  nel percorso %s</center>",
		"es": "<center>Estación de destino desconocida (hasta) %s  en la ruta %s</center>",
		"pl": "<center>Nieznana stacja docelowa (do) %s  na trasie %s</center>",
		"zh-cn": "<center>路线％s中的未知目的站（至）％s</center>"
	},
	"FahrplanConfigErrorStationVia":{
		"en": "<center>Unknown Stopover (Via) %s in Route %s</center>",
		"de": "<center>Unbekannte Zwischenstation (Via) %s in Route %s</center>",
		"ru": "<center>Неизвестная остановка (через) %s  на маршруте %s</center>",
		"pt": "<center>Parada desconhecida (via) %s  na rota %s</center>",
		"nl": "<center>Onbekende tussenstop (via) %s  in route %s</center>",
		"fr": "<center>Escale inconnue (via) %s  sur l'itinéraire %s</center>",
		"it": "<center>Stopover sconosciuto (tramite) %s  nel percorso %s</center>",
		"es": "<center>Escala desconocida (vía) %s  en la ruta %s</center>",
		"pl": "<center>Nieznany postój (przez) %s  na trasie %s</center>",
		"zh-cn": "<center>路线％s中的未知中途停留（via）％s</center>"
	},
	"FahrplanConfigErrorStationDepTT":{
		"en": "<center>Unknown Station %s in Departure Timetable %s</center>",
		"de": "<center>Unbekannte Station %s in Abfahrtstafel %s</center>",
		"ru": "<center>Неизвестная станция %s  в расписании отправлений %s</center>",
		"pt": "<center>Estação desconhecida %s  no horário de partida %s</center>",
		"nl": "<center>Onbekend station %s  in vertrektijdschema %s</center>",
		"fr": "<center>Station %s  inconnue dans l’horaire de départ %s</center>",
		"it": "<center>Stazione %s  sconosciuta nell'orario di partenza %s</center>",
		"es": "<center>Estación desconocida %s  en el horario de salida %s</center>",
