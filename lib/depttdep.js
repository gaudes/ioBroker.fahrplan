...
class fDepTTDep{
	...
	*/
	parse(Departure){
		...
		try{
            ...
            this.helper.ErrorReporting(e, `Exception in Connection for Departure Timetable`, "fDepTTDep", "parse", "", {json: Departure});
		} 
    }
	...
	* @param {number} DepartureIndex Index number of Departure
	*/
	async write(BasePath, DepTTIndex, DepartureIndex){
		try {  
            ...
            this.helper.ErrorReporting(e, `Exception in Connection for Departure Timetable ${DepTTIndex} `, "fDepTTDep", "write", "", {json: this.json});
	...
	*/
	createHTML(){
		try{
            ...
            this.helper.ErrorReporting(e, `Exception in Connection for Departure Timetable`, "fDepTTDep", "createHTML", "", {json: this.json});
            throw this.helper.ErrorCustom("HANDLED");
		} 
	} 
} 
