	...
	*/
	async deleteUnusedSections(iRoute, iConnection, iSections){
		...
		try{
			...
			this.ErrorReporting(e, `Exception removing unused Sections`, "fHelpers", "deleteUnusedSections", "DeleteStates",{json: JSON.stringify(Status)});
		}
		let ChannelsJSON;
		try{
	...
	*/
	async deleteUnusedConnections(iRoute, iConnections){
		...
		try{
			...
			this.ErrorReporting(e, `Exception removing unused Connections`, "fHelpers", "deleteUnusedConnections", "DeleteStates",{json: JSON.stringify(Status)});
		}
		let ChannelsJSON;
		try{
			const Channels = await this.Fahrplan.getChannels();
