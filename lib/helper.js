	...
	*/
	async deleteUnusedConnections(iRoute, iConnections){
		...
		try{
			...
			await this.Fahrplan.getChannels((error, Channels) => {
				if (Channels){
			...
			this.ErrorReporting(e, `Exception removing unused Connections`, "fHelpers", "deleteUnusedConnections", "",{json: ChannelsJSON});
		}
	}
	//#endregion
