	...
	*/
	async writeLine(BasePath){
		try {
			...
			await this.helper.SetTextState(`${BasePath}.Platfrom`, "Line Platform", "Line Platform", this.platform);
			await this.helper.SetTextState(`${BasePath}.PlannedPlatform`, "Line PlannedPlatform", "Line PlannedPlatform", this.plannedPlatform);
		} catch(e) {
