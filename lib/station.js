	...
	*/
	async getStation(eBhf){
		...
		try {  
			...
			throw new Error(`Exception in fStation/getStation [${e}]`);
		} 	
	}
	...
	*/
	async setStation(Station){
		try {  
			...
			throw new Error(`Exception in fStation/setStation [${e}]`);
		} 	
	}
	...
	*/
	async writeStation(BasePath, BaseDesc){
		try { 
			...
			throw new Error(`Exception in fStation/writeStation [${e}]`);
		} 	
	}
}
